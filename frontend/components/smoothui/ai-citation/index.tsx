  ...
  return (
    ...
    >
      <a
        ...
        className="inline-flex h-4 min-w-4 items-center justify-center rounded-full border border-hairline bg-canvas-subtle px-1 font-medium text-[10px] text-muted-foreground no-underline transition-colors hover:border-foreground/30 hover:text-foreground"
        href={url}
      ...
      <AnimatePresence>
        {isOpen ? (
          <motion.span
            ...
            className="absolute bottom-full left-1/2 z-50 mb-1.5 block rounded-xl border border-hairline bg-surface p-3 text-left align-baseline shadow-lg"
            exit={
              shouldReduceMotion

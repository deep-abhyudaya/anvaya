  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        "hover:bg-canvas-subtle hover:text-foreground",
        ...
        >
          ...
          <div className="flex justify-end">
            <div className="flex flex-col items-end gap-2">
              <div className="max-w-full rounded-2xl rounded-br-md bg-accent px-3.5 py-2.5 text-bg">
          ...
          <div className="flex justify-start">
            <div className="max-w-[80%] rounded-2xl rounded-bl-md bg-canvas-subtle px-3.5 py-2.5">

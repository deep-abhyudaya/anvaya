...
const AIArtifact = ({
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 border-hairline border-b px-2 py-1.5">
        <span className="min-w-0 truncate px-1 font-medium text-foreground text-xs">
          {title}
        </span>

        {available.length > 1 && (
          <div className="ml-auto flex items-center gap-0.5 rounded-lg bg-canvas-subtle p-0.5">
